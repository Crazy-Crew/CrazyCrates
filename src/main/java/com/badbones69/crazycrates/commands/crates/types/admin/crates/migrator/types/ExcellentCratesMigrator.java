...
public class ExcellentCratesMigrator implements MigratorInterface {
    ...
    public void run() {
        ...
        for (final Crate crate : CratesAPI.getCrateManager().getCrates()) {
            ...
            set(root, "CrateName", crate.getName());

            set(root, "Preview-Name", crate.getName());

            set(root, "Name", crate.getName());
            set(root, "Lore", List.of("<gray>This crate contains strange objects."));

            set(root, "Preview.Toggle", true);
            set(root, "Preview.ChestLines", true);
            ...
            set(root, "Item", crateItem.getType().getKey().getKey());
            ...
            //todo() get the hologram shit from their templates.
            set(root, "Hologram.Toggle", crate.isHologramEnabled());
            set(root, "Hologram.Height", 1.5);
            set(root, "Hologram.Range", 8);
            set(root, "Hologram.Update-Interval", -1);
            set(root, "Hologram.Color", "transparent");
            set(root, "Hologram.Message", List.of("<bold>%crate% crate</bold>".replace("%crate%", crate.getName())));
            ...
            if (value.isPresent()) {
                ...
                set(root, "PhysicalKey.Glowing", key.getConfig().contains("Item.Enchants"));
            }
