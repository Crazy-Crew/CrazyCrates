...
public class ItemBuilder {
    ...
    public ItemStack build() {
        ...
        if (item == null) {
            ...
            } else if (PluginSupport.oraxen.isPluginEnabled(plugin)) {
     ...
     */
    public ItemBuilder convertString(String itemString) {
     ...
     */
    public List<ItemBuilder> convertStringList(List<String> itemStrings) {
