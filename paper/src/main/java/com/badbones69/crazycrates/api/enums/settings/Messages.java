...
public enum Messages {
    ...
    public static String convertList(List<String> list, Methods methods) {
    ...
    public String getMessage(Methods methods) {
        return getMessage(true, methods);
    }

    public String getMessage(String placeholder, String replacement, Methods methods) {
        Map<String, String> placeholders = new HashMap<>();
        placeholders.put(placeholder, replacement);

        return getMessage(placeholders, true, methods);
    }

    public String getMessage(Map<String, String> placeholders, Methods methods) {
        return getMessage(placeholders, true, methods);
    }

    public String getMessageNoPrefix(Methods methods) {
        return getMessage(false, methods);
    }

    public String getMessageNoPrefix(String placeholder, String replacement, Methods methods) {
        Map<String, String> placeholders = new HashMap<>();
        placeholders.put(placeholder, replacement);

        return getMessage(placeholders, false, methods);
    }

    public String getMessageNoPrefix(Map<String, String> placeholders, Methods methods) {
        return getMessage(placeholders, false, methods);
    }

    private String getMessage(boolean prefix, Methods methods) {
        return getMessage(new HashMap<>(), prefix, methods);
    }

    private String getMessage(Map<String, String> placeholders, boolean prefix, Methods methods) {
        String message;
        ...
        if (isList) {
            if (exists) {
                message = methods.color(convertList(FileManager.Files.MESSAGES.getFile().getStringList("Messages." + path), methods));
            } else {
                message = methods.color(convertList(getDefaultListMessage(), methods));
            }
        } else {
            if (exists) {
