...
public class WarCrate extends CrateBuilder {
    ...
    private final Map<@NotNull Key, String> colorCodes = new HashMap<net.kyori.adventure.key.@NotNull Key, String>();
    ...
    private void getColorCode() {
        this.colorCodes.put(ItemType.WHITE_STAINED_GLASS_PANE.key(), "white");
        this.colorCodes.put(ItemType.ORANGE_STAINED_GLASS_PANE.key(), "gold");
        this.colorCodes.put(ItemType.MAGENTA_STAINED_GLASS_PANE.key(), "light_purple");
        this.colorCodes.put(ItemType.LIGHT_BLUE_STAINED_GLASS_PANE.key(), "dark_aqua");
        this.colorCodes.put(ItemType.YELLOW_STAINED_GLASS_PANE.key(), "yellow");
        this.colorCodes.put(ItemType.LIME_STAINED_GLASS_PANE.key(), "green");
        this.colorCodes.put(ItemType.PINK_STAINED_GLASS_PANE.key(), "red");
        this.colorCodes.put(ItemType.GRAY_STAINED_GLASS_PANE.key(), "dark_gray");
        this.colorCodes.put(ItemType.LIGHT_GRAY_STAINED_GLASS_PANE.key(), "gray");
        this.colorCodes.put(ItemType.CYAN_STAINED_GLASS_PANE.key(), "aqua");
        this.colorCodes.put(ItemType.PURPLE_STAINED_GLASS_PANE.key(), "dark_purple");
        this.colorCodes.put(ItemType.BLUE_STAINED_GLASS_PANE.key(), "dark_blue");
        this.colorCodes.put(ItemType.BROWN_STAINED_GLASS_PANE.key(), "gold");
        this.colorCodes.put(ItemType.GREEN_STAINED_GLASS_PANE.key(), "green");
        this.colorCodes.put(ItemType.RED_STAINED_GLASS_PANE.key(), "dark_red");
        this.colorCodes.put(ItemType.BLACK_STAINED_GLASS_PANE.key(), "black");
    }
}