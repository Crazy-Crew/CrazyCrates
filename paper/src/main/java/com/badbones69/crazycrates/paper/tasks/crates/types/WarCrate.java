...
public class WarCrate extends CrateBuilder {
    ...
    private void setRandomGlass() {
        ...
        builder.withDisplayName("<" + this.colorCodes.get(builder.getType()) + "><bold>???</bold>");
    ...
    private void getColorCode() {
        this.colorCodes.put(ItemType.WHITE_STAINED_GLASS_PANE, "white");
        this.colorCodes.put(ItemType.ORANGE_STAINED_GLASS_PANE, "gold");
        this.colorCodes.put(ItemType.MAGENTA_STAINED_GLASS_PANE, "light_purple");
        this.colorCodes.put(ItemType.LIGHT_BLUE_STAINED_GLASS_PANE, "dark_aqua");
        this.colorCodes.put(ItemType.YELLOW_STAINED_GLASS_PANE, "yellow");
        this.colorCodes.put(ItemType.LIME_STAINED_GLASS_PANE, "green");
        this.colorCodes.put(ItemType.PINK_STAINED_GLASS_PANE, "red");
        this.colorCodes.put(ItemType.GRAY_STAINED_GLASS_PANE, "dark_gray");
        this.colorCodes.put(ItemType.LIGHT_GRAY_STAINED_GLASS_PANE, "gray");
        this.colorCodes.put(ItemType.CYAN_STAINED_GLASS_PANE, "aqua");
        this.colorCodes.put(ItemType.PURPLE_STAINED_GLASS_PANE, "dark_purple");
        this.colorCodes.put(ItemType.BLUE_STAINED_GLASS_PANE, "dark_blue");
        this.colorCodes.put(ItemType.BROWN_STAINED_GLASS_PANE, "gold");
        this.colorCodes.put(ItemType.GREEN_STAINED_GLASS_PANE, "green");
        this.colorCodes.put(ItemType.RED_STAINED_GLASS_PANE, "dark_red");
        this.colorCodes.put(ItemType.BLACK_STAINED_GLASS_PANE, "black");
    }
}