...
public class CsgoCrate extends CrateBuilder {
            ...
            public void run() {
                ...
                if (this.full > 51) {
                    ...
                    if (this.time == 60) { // When done
                        ...
                        final ItemStack itemStack = new ItemBuilder(material.isEmpty() ? Material.GRAY_STAINED_GLASS.getKey().getKey() : material).withDisplayName(" ").asItemStack();
    ...
    private void populate() {
        ...
        if (!material.isEmpty()) {
            final ItemStack itemStack = new ItemBuilder(material).withDisplayName(" ").asItemStack();
