...
public enum FileKeys {
    ...
    public @NotNull final LogCustomFile getLogCustomFile() {
        final Optional<LogCustomFile> customFile = this.fileManager.getLogFile(this.location);
    ...
    public void save(@NotNull final String content) {
        getLogCustomFile().save(content);
    }
