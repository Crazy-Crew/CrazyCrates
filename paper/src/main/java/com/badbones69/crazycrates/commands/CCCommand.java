...
public class CCCommand implements CommandExecutor {
    ...
    public CCCommand(CrazyCrates plugin, FileManager fileManager, CrazyManager crazyManager, Methods methods, MenuListener menuListener, PreviewListener previewListener, CrateControlListener crateControlListener) {
        this.plugin = plugin;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String commandLabel, String[] args) {
        if (args.length == 0) {
            ...
            if (args[0].equalsIgnoreCase("help")) {
                ...
                if (sender instanceof Player) {
                    if (!methods.permCheck(sender, Permissions.CRAZY_CRATES_ADMIN_PREVIEW, false)) return true;
                }
