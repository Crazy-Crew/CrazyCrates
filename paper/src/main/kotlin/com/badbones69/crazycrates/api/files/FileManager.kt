...
import com.badbones69.crazycrates.utils.plugin
                ...
                autoGenerated.keys.forEach { fileName ->
                    if (autoGenerated[fileName].equals(folder, ignoreCase = true)) {
                        ...
                        runCatching {
                            ...
                            val serverFile = File(plugin.dataFolder, "$homeFolder/$fileName")

                            FileUtils.extract("/crates/", serverFile.toPath(), false)
