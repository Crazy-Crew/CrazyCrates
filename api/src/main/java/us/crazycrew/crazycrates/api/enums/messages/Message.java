...
public enum Message {
    ...
    command_migrate_success("", "command.migrate.success", List.of(
            "<bold><gold>━━━━━━━━━━━━━━━━━━━ Migration Stats ━━━━━━━━━━━━━━━━━━━</gold></bold>",
            "<dark_gray>»</dark_gray> <green>Successful Conversions: ",
            " ⤷ {succeeded_amount}</green>",
            "<dark_gray>»</dark_gray> <red>Failed Conversions: ",
    ...
    command_help("Messages.Help", "command.help", List.of(
    ...
    Message(final String oldPath, final String id, final List<String> defaultValue, final Object... path) {
