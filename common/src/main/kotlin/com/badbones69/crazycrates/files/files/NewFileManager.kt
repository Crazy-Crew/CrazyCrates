...
object NewFileManager {
    ...
    fun setup(path: Path): NewFileManager {
    ...
    fun registerCustomFolder(homeFolder: String): NewFileManager {
        homeFolders.add(homeFolder)

        return this
    }

    fun unregisterCustomFolder(homeFolder: String): NewFileManager {
        homeFolders.remove(homeFolder)

        return this
    }

    fun registerDefaultGeneratedFiles(fileName: String, homeFolder: String): NewFileManager {
    ...
    fun unregisterDefaultGeneratedFiles(fileName: String): NewFileManager {
