package com.badbones69.common.config.impl.messages;
...
public class ErrorKeys implements SettingsHolder {
    ...
    @Comment("A list of available placeholders: {prize}")
    public static final Property<String> prize_not_found = newProperty("errors.prize-not-found", "{prefix}<red>The prize named {prize} entered could not be found.");
