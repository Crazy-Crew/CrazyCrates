...
public class CSGO implements Listener {
    ...
    private static void setGlass(Inventory inv) {
        ...
        inv.setItem(4, new ItemBuilder().setMaterial("STAINED_GLASS_PANE:15").setName(" ").build());
        inv.setItem(4 + 18, new ItemBuilder().setMaterial("STAINED_GLASS_PANE:15").setName(" ").build());
